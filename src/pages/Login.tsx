...
export default function Login() {
  ...
  const formikSignUp = useFormik<SignUpFormValues>({
    ...
    validationSchema: Yup.object({
      name: Yup.string()
        ...
        .matches(/^[a-zA-Z\s]+$/, 'Nama tidak boleh mengandung karakter khusus atau emotikon'),
  ...
  return (
    <div className="grid min-h-screen md:grid-cols-2 md:p-2">
      <div className="h-screen overflow-y-auto bg-white p-20 md:p-24">
        <div className="flex flex-col gap-6">
          ...
          <div>
            <Tabs defaultValue={tabsValue} onValueChange={setTabsValue}>
              <TabsList className="h-12 w-full gap-2 rounded-3xl border-2 border-gray-200 p-1 text-gray-600">
                <TabsTrigger
                  value="sign-in"
                  className="data-[state=active]:bg-pertamina-pastel-blue h-10 w-full cursor-pointer transition-all duration-200 data-[state=active]:rounded-2xl data-[state=active]:text-white data-[state=active]:shadow-none"
                >
              ...
              <TabsContent value="sign-in" className="mt-4">
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    tabIndex={3}
                    className={`bg-pertamina-pastel-blue mt-4 w-full cursor-pointer rounded-3xl py-6 ${
          ...
          <div className="w-full space-y-4">
            ...
            <div className="relative flex items-center gap-2">
              <Separator className="flex-1 rounded-4xl bg-gray-200 p-px" />
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                variant="outline"
                className="flex w-full cursor-pointer items-center gap-3 rounded-full border-gray-300 py-6"
              >
                <FcGoogle size={20} />
      ...
      <Card
        className="hidden rounded-3xl border-0 p-14 opacity-95 md:block"
        style={{
